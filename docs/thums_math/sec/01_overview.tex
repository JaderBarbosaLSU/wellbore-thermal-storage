...
That last sentence held for as long as the cycles were believed. At v0.9 both
of them turned out to be wrong, and in the direction that matters
(\S\ref{sec:defects:orcpinch}, \S\ref{sec:defects:ihx2}). The ORC evaporator was
running heat uphill over four fifths of its surface, and the heat pump was
creating \SI{4.8}{\percent} of its own condenser duty in a regenerator.
...
$\mathrm{COP}$               & 2.9563 & \textbf{2.8868} & IHX-2 flow split \\
$\Nwells$                    & 11.632 & \textbf{15.659} & consequence of both \\
$\eta_{\mathrm{RTE}}$        & 0.4367 & \textbf{0.3140} & consequence of both \\
\midrule
...
one storage quantity moves, in any digit carried. The upper block is the cost of
having believed them. \textbf{Read $\eta_{\mathrm{RTE}}=0.31$, not $0.44$}, and
