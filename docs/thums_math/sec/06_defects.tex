...
L_{\mathrm{tube}}]$, so at a given \emph{depth} $d$ the two legs sit at
developed positions $s=d$ and $s=L_{\mathrm{tube}}-d$ --- in different layers:
...
\textbf{0.4a} & 2026-09 &
  ...
  stated explicitly and quantified (\S\ref{sec:defects:h9}). \\
0.4 & 2026-09 &
