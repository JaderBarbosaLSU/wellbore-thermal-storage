...
\textbf{0.9} & 2026-09 &
  ...
  \SI{4.8}{\percent}. $\eta_{\mathrm{ORC}}$ $0.2320\to0.1738$, $\mathrm{COP}$
  $2.9563\to2.8868$, $\Nwells$ $11.632\to15.659$, $\eta_{\mathrm{RTE}}$
  $0.4367\to0.3140$. \emph{Every} storage quantity is unchanged to the last
