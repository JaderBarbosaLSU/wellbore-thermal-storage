...
melting temperature: in the case examined here \num{82} of the \num{100}
segments finish each charge fully molten, and \SI{8.2}{\percent} of the energy
passing through the store each cycle is carried as superheated liquid or
subcooled solid --- states an area has no way to encode.
...
$0.407$ to $0.000$, and the phase-change material that never cycles --- dead
