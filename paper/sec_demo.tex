...
\begin{axis}[width=0.48\linewidth,height=5.4cm,
  ...
  title={\small (a) energy delivered}, ymin=0.91, ymax=1.09, xmin=8.5, xmax=16.5,
  grid=both, grid style={gray!20}]
\addplot[thick,mark=*,mark size=1.3pt,blue!70!black] coordinates {(9.00,0.92431) (10.00,0.98625) (11.63,1.04529) (13.00,1.05987) (16.00,1.07467)};
\addplot[dashed,gray,domain=8.5:16.5,samples=2,forget plot] {1};
\node[font=\scriptsize,gray] at (axis cs:15.0,0.985) {target};
\end{axis}
\begin{axis}[width=0.48\linewidth,height=5.4cm,at={(0.52\linewidth,0)},
  xlabel={$\Nwells$},
  ylabel={residual $\varepsilon_{\mathrm{local}}$},
  title={\small (b) unfrozen fraction at end of discharge},
  ymin=-0.005, ymax=0.095, xmin=8.5, xmax=16.5,
  grid=both, grid style={gray!20}]
\addplot[thick,mark=triangle*,mark size=1.6pt,orange!85!black] coordinates {(9.00,0.0000) (10.00,0.0000) (11.63,0.0116) (13.00,0.0399) (16.00,0.0983)};
\end{axis}
\end{tikzpicture}
...
$\Nwells\approx10.2$, \emph{below} the latent-only count of $11.63$.
