...
At the latent-only size the field delivers \SI{104.73}{\percent} of target. The
store comes close to melting completely at end of charge ---
$\varepsilon_{\mathrm{local}}=1$ at \num{82} of \num{100} stations, mean
$0.9706$ --- and returns to a mean of $0.0094$, so it very nearly refreezes. The
...
\begin{axis}[width=0.48\linewidth,height=5.4cm,
  ...
  grid=both, grid style={gray!20}]
\addplot[thick,mark=*,mark size=1.3pt,blue!70!black] coordinates {(9.00,0.92826) (10.00,0.98936) (11.63,1.04733) (12.50,1.05763) (14.00,1.06836) (16.00,1.07659)};
...
\begin{axis}[width=0.48\linewidth,height=5.4cm,at={(0.52\linewidth,0)},
  ...
  grid=both, grid style={gray!20}]
\addplot[thick,mark=triangle*,mark size=1.6pt,orange!85!black] coordinates {(9.00,0.0000) (10.00,0.0000) (11.63,0.0094) (12.50,0.0255) (14.00,0.0529) (16.00,0.0826)};
\end{axis}
\end{tikzpicture}
...
$\Nwells\approx10.1$, \emph{below} the latent-only count of $11.63$.
